  ...
  return (
    <div className="container border d-flex flex-column my-5 text-center">
      ...
      >
        ...
        <div  className="container border my-3 mx-2 p-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" className="bi bi-tools" viewBox="0 0 16 16">
        ...
        <h3>
          I'm a worker, looking for a work
        </h3>
        <div className="form-check" style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
          <b>
        <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1"/></b>
        </div>
        </div>
      </div>
